...
def test_group_class_1():
    ...
    return helper('test_artifacts/test_1.csv', 'test_artifacts/expected_output_group_test_1.csv', 'test_artifacts/test_1.yaml')


def test_bias_class_1():
    # test that the results from bias are as expected (note it also tests group)
    return helper('test_artifacts/test_1.csv', 'test_artifacts/expected_output_bias_test_1.csv', 'test_artifacts/test_1.yaml')


def test_fairness_class_1():
    # test that the results from fairness are as expected (note it also tests bias and group)
    return helper('test_artifacts/test_1.csv', 'test_artifacts/expected_output_fairness_test_1.csv', 'test_artifacts/test_1.yaml')


def test_common_attributes_2():
    # test that aequitas deals with shared group attribute labels
    return helper('test_artifacts/test_2.csv', 'test_artifacts/expected_output_test_2.csv', 'test_artifacts/test_2.yaml')


def test_all_1_scores_3():
    return helper('test_artifacts/test_3.csv', 'test_artifacts/expected_output_test_3.csv', 'test_artifacts/test_1.yaml')


def test_all_0_scores_4():
    return helper('test_artifacts/test_4.csv', 'test_artifacts/expected_output_test_4.csv', 'test_artifacts/test_1.yaml')


def test_all_1_labels_5():
    return helper('test_artifacts/test_5.csv', 'test_artifacts/expected_output_test_5.csv', 'test_artifacts/test_1.yaml')


def test_all_0_labels_6():
    return helper('test_artifacts/test_6.csv', 'test_artifacts/expected_output_test_6.csv', 'test_artifacts/test_1.yaml')


def test_threshold_7():
    return helper('test_artifacts/test_1.csv', 'test_artifacts/expected_output_test_7.csv', 'test_artifacts/test_3.yaml')


def test_threshold_8():
    return helper('test_artifacts/test_1.csv', 'test_artifacts/expected_output_test_8.csv', 'test_artifacts/test_4.yaml')
