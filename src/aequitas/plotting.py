...
def locate_ref_group_indices(disparities_table, attribute_name, group_metric,
    ...
    ind = list(disparities_table[(disparities_table['attribute_name'] == attribute_name) &
                  (disparities_table['attribute_value'] == all_ref_groups[attribute_name][abs_metric]) &
...
def plot_disparity(disparity_table, group_metric, attribute_name,
    ...
    ref_group_idx = locate_ref_group_indices(disparities_table=sorted_df,
...
def plot_fairness_disparity(fairness_table, group_metric, attribute_name,
    ...
    :return:
    """
    return plot_disparity(disparity_table=fairness_table,
                                  group_metric=group_metric,
                                  attribute_name=attribute_name,
...
def plot_fairness_group_all(fairness_table, metrics=None, fillzeros=True, ncols=3,
    ...
    :return: Returns a figure
    '''
    return plot_multiple(fairness_table, plot_fcn=plot_fairness_group,
                         metrics=metrics, fillzeros=fillzeros,
                         title=title, ncols=ncols, label_dict=label_dict,
                         show_figure=show_figure)


def plot_fairness_disparity_all(fairness_table, attributes=None, metrics=None,
    ...
    :return: Returns a figure
    '''
    return plot_multiple_treemaps(fairness_table, plot_fcn=plot_disparity,
                                  attributes=attributes, metrics=metrics,
                                  fillzeros=fillzeros, title=title,
