...
class Fairness(object):
    ...
    def get_overall_fairness(self, group_variable_df):
        ...
        """
        overall_fairness = {}
        overall_fairness['Unsupervised Fairness'] = False if group_variable_df[
                                                                 'Unsupervised Fairness'].min() \
                                                             is False else True
        overall_fairness['Supervised Fairness'] = False if group_variable_df[
                                                               'Supervised Fairness'].min() \
                                                           is False else True
        if overall_fairness['Unsupervised Fairness'] is True and \
                overall_fairness['Supervised Fairness'] is True:
