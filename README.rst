...
`Explore bias analysis of the COMPAS data`__ .. _https://github.com/dssg/aequitas/blob/master/docs/source/examples/compas_demo.ipynb using the Aequitas library
